...
const TransferPaymentSearchUserDialog = ({
  open,
  onClose,
  onSubmit,
}: {
  ...
  const { data, isFetching } = trpc.transferPayment.searchUser.useQuery(search);
  const result = data ?? [];
...
export default TransferPaymentSearchUserDialog;
