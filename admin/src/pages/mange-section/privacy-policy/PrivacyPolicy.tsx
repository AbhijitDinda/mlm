...
const PrivacyPolicy = () => {
  ...
  const { data, isLoading } = trpc.manageSection.getPrivacyPolicy.useQuery();
  useEffect(() => {
  ...
  const { mutate, isLoading: isSubmitting } =
    trpc.manageSection.updatePrivacyPolicy.useMutation({
      onSuccess(data, variables) {
        utils.manageSection.getPrivacyPolicy.setData(undefined, variables);
        stopEditing();
      },
    });
