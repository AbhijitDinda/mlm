...
const CommissionPolicy = () => {
  ...
  const { data, isLoading } = trpc.manageSection.getCommissionPolicy.useQuery();
  ...
  const { mutate, isLoading: isSubmitting } =
    trpc.manageSection.updateCommissionPolicy.useMutation({
      onSuccess(data, variables) {
        utils.manageSection.getCommissionPolicy.setData(undefined, variables);
        stopEditing();
      },
    });
  ...
  return (
    <Page title="Commission Policy">
      ...
      <HeaderBreadcrumbs
        ...
        links={[{ name: "Manage Section" }, { name: "Commission Policy" }]}
      />
      {/* Breadcrumb End */}
      {isLoading ? (
        <LinearProgress />
