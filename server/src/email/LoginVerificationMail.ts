const LoginVerificationMail = (otp: number) => {
  return ` <p style="font-size:36px;line-height:42px;margin:30px 0;color:#1d1c1d;font-weight:700;padding:0">Login Verification</p>
...
export default LoginVerificationMail;
