const ResetPasswordMail = (otp: number) => {
  return ` <p style="font-size:36px;line-height:42px;margin:30px 0;color:#1d1c1d;font-weight:700;padding:0">Reset Password</p>
<p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">You request to reset your password. Your verification code is:</p>
